"""
K리그 패스 좌표 예측 - 6x6 min_samples=24

Week 2 실험: min_samples 미세 조정
- 6x6 Zone + 8-way Direction
- min_samples: 24 (기존 25)
...
print("=" * 80)
print("K리그 패스 좌표 예측 - 6x6 min_samples=24")
print("=" * 80)
...
submission.to_csv('/mnt/c/LSJ/dacon/dacon/kleague-algorithm/submission_6x6_min24.csv', index=False)

print("  submission_6x6_min24.csv 저장 완료")
