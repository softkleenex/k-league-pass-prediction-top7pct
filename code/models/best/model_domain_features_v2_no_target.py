"""
Domain Features v2: No Target Encoding

Phase 1: Target Encoding 제거
- Player/Team 통계 7개 피처 제거
- 예상: CV 15.11, Public 15.52 (Gap +0.41)
- 목표: Gap 감소 (기존 +1.14 → +0.41)
...
print("=" * 80)
print("K리그 패스 좌표 예측 - Domain Features v2 (No Target Encoding)")
print("=" * 80)
...
print(f"  총 피처 수: {len(feature_cols)} (Target Encoding 7개 제거)")
print(f"  Categorical: {len(categorical_features)}개")
print(f"\n  제거된 피처:")
print(f"    - player_avg_dx, player_avg_dy, player_avg_distance, player_forward_ratio")
print(f"    - team_avg_dx, team_avg_dy, team_avg_distance")

# =============================================================================
# 4. GroupKFold 교차 검증
# =============================================================================
print("\n[4] GroupKFold 교차 검증 (No Target Encoding)...")
...
filename = f'submission_domain_v2_no_target_cv{fold13_cv:.2f}.csv'
