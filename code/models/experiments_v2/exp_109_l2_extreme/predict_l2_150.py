"""
exp_109: Create submission with L2=150 (best from grid search)
CatBoost L2=150, 7 seeds, 11 folds
"""
import pandas as pd
import numpy as np
...
def main():
    ...
    # Train with 7 seeds
    print("Training CatBoost (7 seeds)...")
    ...
    pred_x = np.clip(start_xy[:, 0] + final_dx, 0, 105)
    ...
    output_path = SUBMISSION_DIR / "submission_l2_150_cv13.57.csv"
