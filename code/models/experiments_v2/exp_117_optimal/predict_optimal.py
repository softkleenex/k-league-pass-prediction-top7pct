"""
exp_117: Optimal Settings Prediction
...
def load_test_data():
    """Load test data from individual CSV files"""
...
def main():
    print("="*60)
    print("exp_117: Optimal Prediction")
    print("LR=0.01, i=3000, 16 features, 11-fold, 7-seeds")
    print("="*60)
    ...
    out_path = BASE / f'submissions/submission_optimal_cv{final_cv:.2f}.csv'
