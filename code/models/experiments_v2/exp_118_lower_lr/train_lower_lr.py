"""
exp_118: Even Lower Learning Rates
- Test LR: 0.005, 0.008, 0.01 (current best)
...
def main():
    print("="*60)
    print("exp_118: Even Lower Learning Rates")
    print("="*60)
    ...
    lr_configs = [
        {'lr': 0.005, 'iters': 5000},
        {'lr': 0.008, 'iters': 4000},
        {'lr': 0.01, 'iters': 3000},  # current best
        {'lr': 0.005, 'iters': 7000},  # even more iters
    ]
