"""
exp_124: Best Settings Prediction
- Depth=9, L2=600
...
def main():
    print("="*60)
    print("Best Prediction: Depth=9, L2=600")
    ...
    for seed in seeds:
        print(f"\nSeed {seed}...")
        params = {'iterations': 3000, 'depth': 9, 'learning_rate': 0.01,
    ...
    out_path = BASE / f'submissions/submission_depth9_l2_600_cv{final_cv:.2f}.csv'
