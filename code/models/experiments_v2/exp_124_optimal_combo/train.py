"""exp_124: Optimal Combination (Depth=9 + L2=500)"""
import pandas as pd
import numpy as np
...
def main():
    print("="*60)
    print("exp_124: Optimal Combo (Depth=9 + L2=500)")
    print("="*60)
    ...
    # Test combinations
    configs = [
        ('Depth=8, L2=300 (baseline)', {'depth': 8, 'l2_leaf_reg': 300.0}),
        ('Depth=9, L2=300', {'depth': 9, 'l2_leaf_reg': 300.0}),
        ('Depth=8, L2=500', {'depth': 8, 'l2_leaf_reg': 500.0}),
        ('Depth=9, L2=500', {'depth': 9, 'l2_leaf_reg': 500.0}),
        ('Depth=9, L2=400', {'depth': 9, 'l2_leaf_reg': 400.0}),
        ('Depth=9, L2=600', {'depth': 9, 'l2_leaf_reg': 600.0}),
    ]
    ...
    for name, cfg in configs:
        ...
        for seed in [42, 123, 456]:
            params = {'iterations': 3000, 'learning_rate': 0.01, 'random_state': seed, 'verbose': 0, 'early_stopping_rounds': 100, 'loss_function': 'MAE', **cfg}
            fold_scores = []
