"""
exp_120: Optimal Settings v2
- LR=0.005, iterations=7000 (from exp_118)
- L2=300 (from exp_119)
...
def main():
    print("="*60)
    print("exp_120: Optimal Settings v2")
    print("LR=0.005, i=7000, L2=300, 16 features")
    print("="*60)
    ...
    # Test configurations
    configs = [
        {'name': 'exp_117 baseline (LR=0.01, L2=150)', 'lr': 0.01, 'iters': 3000, 'l2': 150},
        {'name': 'exp_118 best (LR=0.005, L2=150)', 'lr': 0.005, 'iters': 7000, 'l2': 150},
        {'name': 'exp_119 best (LR=0.01, L2=300)', 'lr': 0.01, 'iters': 3000, 'l2': 300},
        {'name': 'OPTIMAL v2 (LR=0.005, L2=300)', 'lr': 0.005, 'iters': 7000, 'l2': 300},
    ]
    ...
    for config in configs:
        ...
        all_scores = []
        for seed in [42, 123, 456]:  # 3 seeds for speed
