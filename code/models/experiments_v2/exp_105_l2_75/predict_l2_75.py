"""
exp_105: L2=75 Optimized (Best from exp_103)
CV: 13.5225
"""
import pandas as pd
import numpy as np
...
def main():
    print("exp_105: L2=75 CatBoost (7 seeds)")
    ...
    # CatBoost L2=75, 7 seeds
    print("Training CatBoost (L2=75)...")
    all_pred_dx, all_pred_dy = [], []
    for seed in SEED_POOL:
        params = {'iterations': 1000, 'depth': 8, 'learning_rate': 0.05,
                  'l2_leaf_reg': 75.0, 'random_state': seed, 'verbose': 0,
    ...
    output_path = SUBMISSION_DIR / "submission_l2_75_cv13.52.csv"
