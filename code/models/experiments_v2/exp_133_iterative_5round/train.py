"""
exp_133: 5-Round Iterative Pseudo-Labeling
"""
import pandas as pd
import numpy as np
...
def main():
    print("=" * 60)
    print("exp_133: 5-Round Iterative Pseudo-Labeling")
    print("=" * 60)
    ...
    for round_num in range(1, n_rounds + 1):
        ...
        if round_num == 1:
            ...
            pseudo_dx, pseudo_dy = train_and_predict(
    ...
    out_path = BASE / 'submissions' / 'submission_iterative_5round.csv'
