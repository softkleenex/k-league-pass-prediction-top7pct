"""
exp_070: LightGBM with MAE Loss
- CatBoost 대신 LightGBM 시도
- MAE Loss 유지
"""
import pandas as pd
import numpy as np
...
def main():
    print("=" * 70)
    print("exp_070: LightGBM with MAE Loss")
    print("=" * 70)
    ...
    output_path = SUBMISSION_DIR / f"submission_lgbm_cv{cv:.2f}.csv"
    submission.to_csv(output_path, index=False)
    print(f"  저장: {output_path}")

    print("\n" + "=" * 70)
    print(f"LightGBM CV: {cv:.4f}")
