"""exp_121: Higher L2 values (350, 400, 500, 600)"""
import pandas as pd
import numpy as np
...
def main():
    print("="*60)
    print("exp_121: Higher L2 (350, 400, 500, 600)")
    print("="*60)
    ...
    l2_values = [300, 350, 400, 500, 600]
    results = {}
    for l2 in l2_values:
        print(f"\nL2={l2}...")
        scores = []
        for seed in [42, 123, 456]:
            params = {'iterations': 3000, 'depth': 8, 'learning_rate': 0.01, 'l2_leaf_reg': float(l2), 'random_state': seed, 'verbose': 0, 'early_stopping_rounds': 100, 'loss_function': 'MAE'}
            fold_scores = []
