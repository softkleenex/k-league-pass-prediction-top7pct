"""exp_123: More seeds (11 seeds) with L2=300"""
import pandas as pd
import numpy as np
...
def main():
    print("="*60)
    print("exp_123: More seeds (11 seeds)")
    print("="*60)
    ...
    seed_configs = {
        '7 seeds': [42, 123, 456, 789, 1000, 2024, 9999],
        '11 seeds': [42, 123, 456, 789, 1000, 2024, 9999, 111, 222, 333, 444],
        '15 seeds': [42, 123, 456, 789, 1000, 2024, 9999, 111, 222, 333, 444, 555, 666, 777, 888],
    }
    ...
    for name, seeds in seed_configs.items():
        ...
        all_scores = []
        for seed in seeds:
            params = {'iterations': 3000, 'depth': 8, 'learning_rate': 0.01, 'l2_leaf_reg': 300.0, 'random_state': seed, 'verbose': 0, 'early_stopping_rounds': 100, 'loss_function': 'MAE'}
            fold_scores = []
