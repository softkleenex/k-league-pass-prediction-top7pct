"""
exp_126: Best Settings Prediction
- Depth=9, L2=600, LR=0.008, iterations=4000
- 11-fold, 7-seeds
"""
import pandas as pd
import numpy as np
...
def main():
    print("="*60)
    print("Best Prediction: Depth=9, L2=600, LR=0.008, i4000")
    ...
    for seed in seeds:
        print(f"\nSeed {seed}...")
        params = {'iterations': 4000, 'depth': 9, 'learning_rate': 0.008,
                  'l2_leaf_reg': 600.0, 'random_state': seed, 'verbose': 0,
    ...
    out_path = BASE / f'submissions/submission_lr008_cv{final_cv:.2f}.csv'
