"""
exp_111: Depth and Iterations Tuning
- Test different depth values: 4, 6, 8, 10, 12
- Test different iterations: 500, 1000, 2000
"""
import pandas as pd
import numpy as np
...
def main():
    print("="*60)
    print("exp_111: Depth and Iterations Tuning")
    print("="*60)
    ...
    configs = [
        ...
        {'depth': 8, 'iterations': 1000},  # baseline
        {'depth': 10, 'iterations': 1000},
        {'depth': 12, 'iterations': 1000},
        {'depth': 8, 'iterations': 500},
        {'depth': 8, 'iterations': 2000},
        {'depth': 6, 'iterations': 2000},  # shallower but more iterations
    ]
    ...
    for config in configs:
        ...
        key = f"d{depth}_i{iters}"

        print(f"\nTesting depth={depth}, iterations={iters}...")

        all_scores = []
        for seed in [42, 123, 456]:
            params = {'iterations': iters, 'depth': depth, 'learning_rate': 0.05,
